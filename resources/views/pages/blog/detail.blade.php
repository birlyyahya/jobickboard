<x-layouts.app>
    <div class="page-content">
        <!-- Banner  -->
        <div class="dz-bnr-inr dz-bnr-inr-sm text-center overlay-primary-dark" style="background-image: url(assets/images/banner/bnr3.jpg);">
            <div class="container">
                            ...
                            <div class="dz-info m-b30">
                                ...
                                <div class="dz-share-post">
                                    ...
                                    <div class="dz-social-icon dark">
                                        <ul>
                                            <li><a target="_blank" class="fab fa-facebook-f" href="https://www.facebook.com/dexignzone/"></a></li>
                                            <li><a target="_blank" class="fab fa-instagram" href="https://www.instagram.com/dexignzone/"></a></li>
                                            <li><a target="_blank" class="fab fa-twitter" href="https://twitter.com/dexignzones"></a></li>
                                            <li><a target="_blank" class="fab fa-youtube" href="https://www.youtube.com/channel/UCGL8V6uxNNMRrk3oZfVct1g"></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-xl-6 m-b30">
                                <div class="dz-card style-1 overlay-shine wow fadeInUp" data-wow-delay="1.0s">
                                    ...
                                    <div class="dz-info">
                                        ...
                                        <h4 class="dz-title"><a href="blog-details.html">5 Reasons Why You Should Invest In Jobs.</a></h4>
                                ...
                                <div class="clearfix">
                                    ...
                                    <ol class="comment-list">
                                        <li class="comment">
                                            <div class="comment-body">
                                                <div class="comment-author vcard">
                                                    <img class="avatar photo" src="assets/images/avatar/avatar1.jpg" alt="">
                                            ...
                                            <ol class="children">
                                                <li class="comment odd parent">
                                                    <div class="comment-body">
                                                        <div class="comment-author vcard">
                                                            <img class="avatar photo" src="assets/images/avatar/avatar2.jpg" alt="">
                                        ...
                                        <li class="comment">
                                            <div class="comment-body">
                                                <div class="comment-author vcard">
                                                    <img class="avatar photo" src="assets/images/avatar/avatar3.jpg" alt="">
