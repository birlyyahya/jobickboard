                                                    ...
                                                    <div class="tab-pane fade show active" id="nav-personal" role="tabpanel" aria-labelledby="nav-personal-tab">
                                                        <form class=" dez-form pb-3">
                                                            ...
                                                            <div class="form-group text-left mb-5">
                                                                <button class="btn btn-primary dz-xs-flex me-3">login</button>
                                                            ...
                                                            <div class="dz-social ">
                                                                ...
                                                                <ul class="dez-social-icon dez-border dez-social-icon-lg text-white">
                                        ...
                                        <div class=" bottom-footer clearfix m-t10 m-b20 row text-center">
                                            <div class="col-lg-12 text-center">
                                                <span> © Copyright by <span class="heart"></span>
                                                    <a href="javascript:void(0);">DexignLab </a> All rights reserved.</span>
                                            </div>
                                        </div>
                                    </div>
