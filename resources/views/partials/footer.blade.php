 ...
 <footer class="site-footer style-1 position-relative">
            <div class="footer-top bg-light {{ $currentRoute == 'homepage' ? 'sapping' : '' }} ">
                <div class="container">
                    <div class="row p-50">
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-12">
                            <div class="widget  wow fadeInUp" data-wow-delay="2.2s">
                                ...
                                <form class="dzSubscribe ft-subscribe mb-4" action="{{ asset('assets/script/mailchamp.php') }}" method="post">
